...
public class RuneMagic extends AbstractElainaCard {
    public static final String ID = "Elaina:RuneMagic";
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID); // 从游戏系统读取本地化资源
    private static final String IMG_PATH = "ElainaMod/img/cards/RuneMagic.png";
    ...
    public void BasicEffect(AbstractPlayer p, AbstractMonster m) {
        int n = CardModifierManager.modifiers(this).size();
        for(int i = 0;i<n+1;i++){
